...
var blockElements = angular.extend({}, optionalEndTagBlockElements, makeMap("address,article," +
        ...
        "h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul,iframe"));
...
var validAttrs = angular.extend({}, uriAttrs, makeMap(
    ...
    'valign,value,vspace,width,allowfullscreen'));
    ...
    start: function(tag, attrs, unary){
      ...
      if (!ignore && validElements[tag] === true) {
        ...
        angular.forEach(attrs, function(value, key){
          ...
          if ((lkey === 'style' && (value = validStyles(value)) !== '') || validCustomTag(tag, attrs, lkey, value) || (validAttrs[lkey] === true || /^data-[\w-]*$/.test(lkey)) &&
